...
const genColorGroup = (color) => {
  ...
  return {
    DEFAULT: `rgba(${r},${g} ,${b})`,
    ...[900, 800, 600, 400, 300, 200, 100, 80, 60].reduce((previousValue, currentValue) => {
      return {
        ...previousValue,
...
const spacingEnhance = [4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5, 12.5, 15, 19, 25, 30].reduce(
...
const lineHeightEnhance = [7.5, 11, 12, 13, 14, 15, 16, 17, 18, 19, 10].reduce((previousValue, currentValue) => {
  return {
    ...previousValue,
    [currentValue]: `${currentValue * 4}px`,
  };
